                                        ...
                                        (
                                            <>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                                    <li>
                                                        <Link className="dropdown-item" to="/Employer/Dashboard">
                                                            Account
                                                        </Link>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <Link className="dropdown-item" to="/Employer/Jobs/Manage-Jobs">
                                                            Manage Job
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link className="dropdown-item" to="/Employer/Jobs/Post-Job">
                                                            Post Job
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link className="dropdown-item" to="/Employer/Jobs/Applied-Jobs">
                                                            Applied Jobs
                                                        </Link>
                                                    </li>
                                                    <li><hr className="dropdown-divider" /></li>
                        ...
                        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                                <li class="nav-item">
                                    ...
                                    <Link class="nav-link active" to="/Employer/Dashboard" onClick={() => { window.location.href = "/Employer/Dashboard" }}>
                                        <span class="nav-icon">
                                        ...
                                        <span class="nav-link-text">Employer Dashboard</span>
                                    </Link>
                                </li>
                                {/* <li class="nav-item">
                                ...
                                <li class="nav-item has-submenu">
                                    <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false" aria-controls="submenu-1">
                                        ...
                                        <span class="nav-link-text">Employer Jobs</span>
                                    ...
                                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                        <ul class="submenu-list list-unstyled">
                                            <li class="submenu-item">
                                                <Link class="submenu-link" to="/Employer/Jobs/Manage-Jobs" onClick={() => { window.location.href = "/Employer/Jobs/Manage-Jobs" }}>
                                                    Manage Jobs
                                                </Link>
                                            </li>
                                            <li class="submenu-item">
                                                <Link class="submenu-link" to="/Employer/Jobs/Post-Job" onClick={() => { window.location.href = "/Employer/Jobs/Post-Job" }}>
                                                    Post New Job
                                                </Link>
                                            </li>
                                            <li class="submenu-item">
                                                <Link class="submenu-link" to="/Employer/Jobs/Applied-Jobs" onClick={() => { window.location.href = "/Employer/Jobs/Applied-Jobs" }}>
                                                    Applied Jobs
                                                </Link>
                                            </li>
                                        </ul>
