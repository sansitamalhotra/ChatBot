...
const ManageProvinces = () => {
    ...
    const [numCitiesInDB, setNumCitiesInDB] = useState(0);
    ...
    const notifySucc = (msg) => toast.success(msg, 
        ...
        useEffect(() => {
            ...
            if (window.history.pushState) {
                window.history.pushState(null, null, `/Admin/Cities/Manage-Cities?page=${currentPage}`);
            }
    ...
    const fetchCities = async () => {
            ...
            {
                setLoading(true);
                const response = await API.get(`/api/v1/city/fetchCities?page=${currentPage}`);
                setCities(response.data.result);

                setTotalCities(response.data.totalCities);
                setNumCitiesInDB(response.data.numCitiesInDB);
    ...
    return (
        <>
            <HeaderSidebar />
            <ChangePageTitle customPageTitle=" Admin Manage Cities | Prosoft Synergies " /> 
            <div className="app-wrapper">
                <div className="app-content pt-3 p-md-3 p-lg-4">
                    <div className="container-xl">
                        <div className="row g-3 mb-4 align-items-center justify-content-between">
                            <div className="col-auto">
                                <h1 className="app-page-title mb-0">Manage Cities</h1>
                                (<strong><span>Page {currentPage} of {" "} {numCitiesInDB} Cities Found</span></strong>)
                            </div>
                        </div>
                            ...
                            <div className="tab-pane fade show active" id="countries-all" role="tabpanel" aria-labelledby="countries-all-tab">
                                        ...
                                        <div className="table-responsive">
                                            <table className="table app-table-hover mb-0 text-left">
                                                <thead>
                                                    ...
                                                    {/* <th class="cell">Id</th> */}
                                                    <th className="cell">City Name</th>
                                                    <th className="cell">City Slug</th>
                                                    <th className="cell">Province / State</th>
                                                        ...
                                                        cities.map((c) => {
                                                            return (
                                                                <tr key={c._id}>
                                                                    ...
                                                                    <td className="cell">
                                                                        <strong>{c?.province?.provinceName}</strong>
                                                                    </td>
                                                                    <td className="cell">
                                                                        <button className="btn-sm app-btn-secondary rounded-0 me-3" onClick={() => {
                                                                                    setVisible(true);
                                                                                    setUpdatedName(c.provinceName);
                                                                                    setSelected(c);
                                                                                }}>
                                                                            <EditOutlined />
                                                                        </button>
                                ...
                                <nav className="app-pagination">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li className="page-item">
                                            <button className="page-link" onClick={nextPage} disabled={ currentPage === Math.ceil(totalCities / 5)}>Next</button>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
