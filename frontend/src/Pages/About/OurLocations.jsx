...
const OurLocations = () => {
    ...
    const onSubmit = async (data) => {
      setLoading(true);
      try {
        const res = await API.post("/contact/contact-form", data);
        if (res.status === 200) {
          window.scrollTo({
            top: 0,
            behavior: "smooth"
        ...
        notifyErr(error.message || "Something went wrong.");
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
        ...
        <Helmet>
            ...
            <title>Find Our Locations | ProsoftSynergies </title>
            <meta
                name="description"
                content="Find Our Locations, One of the Leading Global Job Platform Connecting Employers and Job Seekers Across Canada, the US, and India. Secure Access To Your Account and Explore Endless Career Opportunities."
            />
            <meta
                name="keywords"
