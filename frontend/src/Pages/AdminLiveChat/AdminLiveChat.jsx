...
const AdminLiveChat = () => {
  ...
  useEffect(() => {
    ...
    const handleSessionEnd = (data) => {
      ...
      if (data.sessionId === sessionId) {
        console.log('Session ending - updating admin interface...');
        
        setConnectionStatus('ended');
        
        // Show notification to admin about session ending
        if (data.endedBy === 'guest') {
          console.log('Guest user ended the session');
          ...
          <div className="session-ended-notice">
            <div className="warning-content">
              ...
              <div className="warning-text">
                <span className="warning-title">Chat Session Ended</span>
                <span className="warning-message">
                  {sessionMessage || 'This chat session has been closed and no new messages can be sent.'}
                </span>
              </div>
            </div>
          </div>
