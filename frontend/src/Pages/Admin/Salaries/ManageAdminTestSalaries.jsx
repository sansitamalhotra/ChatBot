    ...
    return (
      <div className="container-scroller">
        <Helmet>
          ...
          <title>Admin Manage Salary Type | ThinkBeyond</title>
          <meta name="description" content="Admin Manage Salary Type | ThinkBeyond" />
        </Helmet>
        <Navbar 
              ...
              <div className="page-header">
                ...
                <strong>
                    <span>
                      ...
                      <Link to="/Admin/Add-Salary" className='btn btn-success'>Add New</Link>
                    </span>
                </strong>
              </div>            
              {/* Stats Cards */}      
                ...
                <div className="col-12 grid-margin">
                  <div className="card">
                    <div className="card-body">
                      <h4 className="card-title">List Of Salary Types</h4>
...
export default ManageAdminTestSalaries;
