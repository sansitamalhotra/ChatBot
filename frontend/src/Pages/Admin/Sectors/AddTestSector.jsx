...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(error);
      notifyErr(
        "Opps!!! FAILED.. Something went wrong, Sector Name Already Exist"
      );
    }
  };
  ...
  return (
      <div className="container-scroller">
        <Helmet>
          ...
          <title>Admin Add Sector | ThinkBeyond</title>
            <meta
            name="description"
            content="Admin Add Sector | ThinkBeyond"
            />
        </Helmet>
        <Navbar 
                ...
                <div className="col-9 grid-margin mx-auto">
                  <div className="card">
                    <div className="card-body">
                      <h4 className="card-title">Add New Sector Form</h4>
                      <AddTestSectorForm
