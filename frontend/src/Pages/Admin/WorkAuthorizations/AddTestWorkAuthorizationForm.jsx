...
const AddTestWorkAuthorizationForm = ({ handleSubmit, value, setValue }) => {

    const navigate = useNavigate();
    const [loading, setLoading] = useState(false);

    const handleCancel = () => {
        navigate('/Admin/Manage-Work-Authorizations'); // Replace '/desired-path' with the actual path you want to navigate to
    };
                    ...
                    <div className="col-md-10 mx-auto">
                        <div className='form boxed'>                        
                            ...
                            <input 
                                ...
                                type='text'
                                className='form-control rounded-0 mb-4 mt-2'
                                value={value}
...
export default AddTestWorkAuthorizationForm;
