...
const ManageAdminTestWorkExperiences = () => {
    ...
    return (
      <div className="container-scroller">
        <Helmet>
          ...
          <title>Admin Manage Work Experiences | ThinkBeyond</title>
          <meta name="description" content="Admin Manage Work Experiences | ThinkBeyond" />
        </Helmet>
        <Navbar 
            ...
            <div className="content-wrapper">
              <div className="page-header">
                <h3 className="page-title">
                  ...
                  </span> Manage Job Work Experiences
                </h3>
                <strong>
                    <span>
                      {/* Page {currentPage} of {numJobsInDB} Jobs Found */}
                      <Link to="/Admin/Test-Add-Work-Experience" className='btn btn-success'>Add New</Link>
                    </span>
                </strong>
              </div>            
              {/* Stats Cards */}      
                ...
                <div className="col-12 grid-margin">
                  <div className="card">
                    <div className="card-body">
                      <h4 className="card-title">List Of Job Work Experiences</h4>
                      <div className="table-responsive">
                        <table className="table">
                          <thead>
                            <tr>
                             <th className="cell">Work Experience Name</th>
                              <th>Slug</th>
                              <th>Action</th>
                            </tr>
                          </thead>
...
export default ManageAdminTestWorkExperiences;
