        ...
        <ul className="nav">
          ...
          <li className="nav-item">
            ...
            <div className="collapse" id="admin-jobs-qualifications">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Qualification">Add Qualifications</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Qualifications">Manage Qualifications</Link>
                </li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
            ...
            <div className="collapse" id="admin-work-experiences">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Work-Experience">Add Work Experience</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Work-Experiences">Manage Work Experiences</Link>
                </li>
              </ul>
            </div>
        </li>
        <li className="nav-item">
            ...
            <div className="collapse" id="admin-work-experiences">
              <ul className="nav flex-column sub-menu">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Business-Hours">Manage Business Hours</Link>
                </li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
            ...
            <div className="collapse" id="admin-work-modes">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Work-Mode">Add Work Mode</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Work-Modes">Manage Work Modes</Link>
                </li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
            ...
            <div className="collapse" id="admin-countries">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Country">Add Country</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Countries">Manage Countries</Link>
                </li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
            ...
            <div className="collapse" id="admin-provinces">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Province">Add Province</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Provinces">Manage Provinces</Link>
                </li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
            ...
            <div className="collapse" id="sectors">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Sector"> Add Job Sector </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Sectors"> Manage Job Sectors </Link>
                </li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
            ...
            <div className="collapse" id="salaries">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Salary"> Add Salary </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Salaries"> Manage Salaries </Link>
                </li>
              </ul>
            </div>
          </li>
          <li className="nav-item">
            ...
            <div className="collapse" id="workAuthorizations">
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Add-Work-Authorization"> Add Work Authorization </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/Admin/Manage-Work-Authorizations"> Manage Work Authorizations </Link>
                </li>
              </ul>
            </div>
          </li>
